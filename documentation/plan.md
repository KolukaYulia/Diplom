...
3. Срок действия карты. Содержит 2 цифры номер месяца, 2 цифры - текущий или следующие года, не более 6 лет. Например, "месяц 07" год 23".
...
* Шаги.
 ...
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Ошибка! Банк отказал в проведении операции.".
##### 1.2. Валидация поля "Номер карты". Номер карты на одну цифру меньше.
...
* Шаги.
 ...
 3. Ввести валидные значения имя владельца карты, срок действия карты, CVC-код в соответствующие поля
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Неверный формат".
##### 1.3. Валидация поля "Номер карты". Поле пустое.
...
* Шаги.
 ...
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Неверный формат".
##### 2.2. Валидация поля "Владелец карты". Поле содержит 1 латинскую букву.
...
* Шаги.
 ...
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Неверный формат".
##### 2.3. Валидация поля "Владелец карты". Поле содержит цифру.
...
* Шаги.
 ...
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Неверный формат".
##### 2.5. Валидация поля "Владелец карты". Поле содержит символ.
* Описание. "При вводе имени владельца карты, содержащего символ на странице оплаты отображается ошибка"
* Шаги.
 1. Нажать кнопку "Купить"
 2. В поле "Владелец карты" ввести слово на латинице и символ (например, №).
 3. Ввести валидные значения номера карты, срок действия карты, CVC-код в соответствующие поля
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Неверный формат".
...
* Шаги.
 ...
 3. Ввести валидные значения номера карты, срок действия карты, CVC-код в соответствующие поля
 4. Подтвердить
* Ожидаемый результат. Сообщение на странице оплаты "Поле обязательно для заполнения".
...
##### 4.2. Валидация поля "CVC-код". Поле пустое.
